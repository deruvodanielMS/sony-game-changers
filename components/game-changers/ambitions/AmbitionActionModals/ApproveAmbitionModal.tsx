...
export function ApproveAmbitionModal({
  open,
  onClose,
  onConfirm,
  isLoading = false,
}: AmbitionActionModalProps) {
  const t = useTranslations('AmbitionModals.approve')
...
ApproveAmbitionModal.displayName = 'ApproveAmbitionModal'
